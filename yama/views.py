...
def home():
    ...
    # used to set up a redirect address
    login_session['prev_url'] = '/'

    # NOTE: from this route current_category is fed a dummy val
    # due to shared tmplate. From index, val is set dynamically
    return render_template('index.html', categories=categories, recent_posts=recent, current_category={id:1}, state=getState())
